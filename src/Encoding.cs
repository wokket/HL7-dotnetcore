...
namespace HL7.Dotnetcore
{
    public class HL7Encoding
    {
        ...
        {
            // set the defaults
            _charsThatMightNeedEncoding = new[] { '<', FieldDelimiter, ComponentDelimiter, RepeatDelimiter, EscapeCharacter, SubComponentDelimiter };
        }

        public void EvaluateDelimiters(string delimiters)
        {
            var charsThatMightNeedEncoding = new List<char>(6) { 
                '<' // <br> etc
            };
            ...
            charsThatMightNeedEncoding.Add(EscapeCharacter);
            charsThatMightNeedEncoding.Add(FieldDelimiter);
            charsThatMightNeedEncoding.Add(ComponentDelimiter);
            charsThatMightNeedEncoding.Add(RepeatDelimiter);
            charsThatMightNeedEncoding.Add(SubComponentDelimiter);

            _charsThatMightNeedEncoding = charsThatMightNeedEncoding.ToArray();
        }
